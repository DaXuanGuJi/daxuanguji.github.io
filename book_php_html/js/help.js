...
help["mput"] = "输入图片序列文本;";
help["tbodyrand"] ="开启字符随机:0自定义字符图片目录【\images\body\text\下目录】；1：随机字符图片【\_randomFONT\目录；若目录下没有则调用默认字体kaiT图片】2：本地安装字体【ttf字体】3:ttf字体图片目录【images\font\目录；若目录下没有则调用默认字体kaiT图片】\n设置修改:ptset.bodyobj.trand的值" ;
help["settop"] ="菜单随屏幕滚动" ;
