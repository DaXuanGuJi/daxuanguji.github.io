...
document.body.onload = function (b) {
	...
	stuf.onclick = function (a) {
		window.win = window.open("html/fem.html?" + wpyt.value, "setbox", "top\x3d" + (screen.availHeight - 500) / 4 + ",left\x3d" + (screen.availWidth - 850) / 2 + ",width\x3d850,height\x3d500,directories\x3dno,status\x3dno,location\x3dno,toolbar\x3dno,scrollbars\x3dyes,resizable\x3dno,hotkeys\x3dno")
	};
	...
	stus.onclick = function (a) {
		...
		window.win = window.open("html/fh.html?" + wpyt.value, "setbox", "top\x3d" + (screen.availHeight - 500) / 4 + ",left\x3d" + (screen.availWidth - 850) / 2 + ",width\x3d850,height\x3d500,directories\x3dno,status\x3dno,location\x3dno,toolbar\x3dno,scrollbars\x3dyes,resizable\x3dno,hotkeys\x3dno")
	};
	stuk.onclick = function (a) {
		...
		window.win = window.open("html/book/book.html?" + wpyt.value, "setbox", "top\x3d0,left\x3d300,width\x3d" + (screen.availWidth - 300) + ",height\x3d" + screen.availHeight + ",directories\x3dno,status\x3dno,location\x3dno,toolbar\x3dno,scrollbars\x3dyes,resizable\x3dno,hotkeys\x3dno")
	};
	...
	var H = function (a) {
		...
		window.setimgwind = window.open("html/img.html?" + wpyt.value + "?" + d, "setimgwind", "top\x3d100,left\x3d0,width\x3d350,height\x3d" + (screen.availHeight - 100) + ",directories\x3dno,status\x3dno,location\x3dno,toolbar\x3dno,scrollbars\x3dyes,resizable\x3dno,hotkeys\x3dno")
	};
	...
	set.ondblclick = function (a) {
		0 < "\x3d,tbookpic,tbackpic,tbodypic,tbodybk,tbodycel,ttxtcel,ptceal,ptwat,cosimg1,cosimg2,".indexOf("," + a.target.id + ",") && g(openfile, a.target)
	};
...
ByID("settop").onclick = function (b) {
	"\ud83d\udd1d" == this.innerHTML ? (ByID("set").style.position = "absolute", this.innerHTML = "\u2935\ufe0f") : (ByID("set").style.position = "fixed", this.innerHTML = "\ud83d\udd1d")
};
ByID("hlp").onclick = function (b) {
	...
	container.onmouseover = "block" == container.style.display ? function (b) {
		"field" == b.target.className && (b.target.title = help[b.target.innerHTML])
	}
	 : null
};
